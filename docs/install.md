...
Histos has two front ends, and this page covers both — pick one, or install both and switch anytime (they do exactly the same things to your project; see [usage.md](usage.md) for how they compare day to day):
...
That's it — skip ahead to [usage.md](usage.md). The rest of this page is for the terminal tool, or for building the app yourself from source.
...
- **Everything else** — [usage.md](usage.md) for day-to-day use, or the [README](../README.md) for how Histos actually works.
